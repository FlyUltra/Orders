...
import org.orders.smartinvs.opener.InventoryOpener;
...
public class SmartInventory {
    ...
    public Inventory open(Player player, String figureId) { return open(player, 0, figureId); }

    public Inventory open(Player player, int page, String figureId) {
        ...
        try {
            this.provider.init(player, figureId, contents);
    ...
    public static final class Builder {
        ...
        public SmartInventory build() {
            ...
            InventoryManager manager = this.manager != null ? this.manager : Main.manager();
